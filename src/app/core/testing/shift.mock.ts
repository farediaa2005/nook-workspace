import { ShiftRecord, ShiftHistoryItem, ShiftTransaction } from '../models/shift.model';

/**
 * =========================================================================
 * SHIFT TESTING & MOCK DATA (بيانات الاختبار والمحاكاة لخدمات الورديات)
 * =========================================================================
 * 
 * 💡 ملاحظة: عند الرغبة في تشغيل الـ API الحقيقي 100% وإلغاء البيانات الافتراضية،
 * يمكنك إما تعديل USE_SHIFT_MOCK_DATA إلى false أو إزالة هذا الملف من ShiftService.
 */

// [MOCK DATA DISABLED FOR LIVE API - Set to true for offline presentation/testing]
export const USE_SHIFT_MOCK_DATA = false;

/**
 * بيانات الوردية النشطة الافتراضية لأغراض التيستينج والعرض
 */
...
/**
 * سجل الورديات السابقة الافتراضي للاختبار
 */
